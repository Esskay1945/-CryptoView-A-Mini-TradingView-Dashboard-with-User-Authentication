...
To run this project
1. Check if python exists in your system using command: python --version.
2. Install streamlit to run this project :python -m pip install streamlit pandas plotly requests
3. Run it with: streamlit run app.py
